    ...
    <section id="ingressos" className="py-20 md:py-32 bg-[#080808] relative overflow-hidden scroll-mt-28 md:scroll-mt-32">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 relative z-10">
            <div className="text-center mb-20">
                <span className="text-brand-highlight font-sans text-sm font-bold uppercase mb-4 block">
                    Vagas Limitadas
                </span>
                <h2 className="font-condensed text-4xl md:text-6xl font-normal text-white uppercase mb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start mb-16">
                ...
                <div className="bg-[#111] border border-white/10 rounded-2xl p-8 flex flex-col relative hover:border-white/30 transition-all duration-300 group h-full">
                    <div className="mb-8 border-b border-white/5 pb-8">
                        <span className="bg-white/5 text-gray-300 text-xs font-bold px-3 py-1.5 rounded uppercase">Individual</span>
                        ...
                        <div className="mt-6">
                             ...
                             <p className="text-gray-500 text-xs uppercase mt-1">12x de R$ 29,82</p>
                        </div>
                    </div>
                    ...
                    <button 
                        ...
                        className="w-full block bg-[#1a1a1a] border border-white/10 text-white hover:bg-white hover:text-black font-condensed text-xl text-center py-4 rounded-lg transition-all uppercase mt-auto"
                    >
                        Comprar VIP
                    </button>
                </div>
                ...
                <div className="bg-[#111] border-2 border-[#C20000] rounded-2xl p-8 flex flex-col relative transform lg:-translate-y-6 shadow-[0_0_50px_rgba(194,0,0,0.1)] z-10 h-full">
                    <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#C20000] text-white text-xs font-bold px-6 py-2 rounded-full uppercase shadow-lg whitespace-nowrap flex items-center gap-2">
                        <Zap size={12} fill="white" /> Melhor Custo-Benefício
                    </div>
                    
                    <div className="mb-8 border-b border-white/10 pb-8 mt-2">
                        <span className="bg-brand-red/10 text-brand-highlight text-xs font-bold px-3 py-1.5 rounded uppercase">Dupla (2 Ingressos)</span>
                        ...
                        <div className="mt-6">
                             ...
                             <p className="text-brand-highlight text-xs uppercase mt-1 font-bold">R$ 248,50 por pessoa</p>
                        </div>
                    </div>
                    ...
                    <button 
                        ...
                        className="w-full block bg-[#C20000] hover:bg-[#a50000] text-white font-condensed text-2xl text-center py-5 rounded-lg shadow-lg transition-all uppercase transform hover:scale-[1.02] mt-auto"
                    >
                        Comprar Duplo
                    </button>
                </div>
                ...
                <div className="bg-[#111] border border-white/10 rounded-2xl p-8 flex flex-col relative hover:border-white/30 transition-all duration-300 group h-full">
                    <div className="mb-8 border-b border-white/5 pb-8">
                        <span className="bg-white text-black text-xs font-bold px-3 py-1.5 rounded uppercase flex items-center gap-1 w-max">
                        ...
                        <div className="mt-6">
                             ...
                             <p className="text-gray-500 text-xs uppercase mt-1">12x de R$ 99,90</p>
                        </div>
                    </div>
            ...
            <div className="max-w-3xl mx-auto mb-20 text-center">
                <div className="bg-[#111] border border-dashed border-white/20 rounded-xl p-8 flex flex-col md:flex-row items-center justify-between gap-6 hover:border-brand-red/50 transition-colors">
                    ...
                    <a 
                        href="#" 
                        className="flex items-center gap-2 bg-transparent border border-white/20 text-white hover:bg-white hover:text-black font-bold py-3 px-6 rounded-lg transition-all uppercase text-sm whitespace-nowrap"
                    >
